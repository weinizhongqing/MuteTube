...
import com.tb.music.player.tobe.models.MusicCardShelfRenderer
...
import com.tb.music.player.tobe.models.clean
            ...
            return when {
                renderer.onTap.watchEndpoint != null -> {
                    SongItem(
                        ...
                        album = subtitle.getOrNull(2)?.firstOrNull()
                ...
                renderer.onTap.browseEndpoint?.isPlaylistEndpoint == true -> {
                    PlaylistItem(
                        ...
                        title = renderer.header?.musicCardShelfHeaderBasicRenderer?.title?.runs?.joinToString(
                            separator = ""
                        ) { it.text }
                            ?: return null,
                        author = Artist(
